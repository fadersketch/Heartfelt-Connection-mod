...
本版本经测试者验证,在以下前置模组的具体版本下可以正常运行;其他版本(含更新/更旧的 maidmarriage 与 callresponse)未必兼容:
- maidmarriage(心契誓约) 2.3.0 —— `[车万女仆：心契誓约] maidmarriage-2.3.0-forge+mc1.20.1.jar`;
- callresponse(爱憎分明) 2.0.4 —— `Touhou Little Maid-Love  Loathe-1.20.1-forge-2.0.4.jar`;
- Touhou Little Maid(车万女仆) 1.5.3 —— `[车万女仆] touhoulittlemaid-1.5.3-forge+mc1.20.1.jar`。
